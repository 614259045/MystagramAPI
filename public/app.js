  ...
  res.results.forEach((element) => {
    ...
    <header class="photo__header">
      <div class="photo__header-column">
       <a href="profile.html?username=${element.user.username}"></a>
      <img class="photo__avatar" src="${element.user.profile_image.small}"/>
      </div>
  
    <div class="photo__header-column">
      <span class="photo__username"> <a href="profile.html?username=${element.user.username}">${element.user.username}</span>
    </div>
    </header>
    <div class="photo__file-container">
      <img
      class="photo__file"
      src="${element.urls.raw}"
      />
      </div>
